...
create table VENDA_COMPRA (
	...
	comprador serial not null references CLIENTE(codigo),
	vendedor serial not null references CLIENTE(codigo),
...
insert into LOGRADOURO (nome, tipo_logradouro,fk_BAIRRO_codigo) values
('avenida', 'Ugo Viola', 1),
...
insert into CLIENTE (nome, cpf, data_nascimento, email, senha, fk_endereco_codigo) values
('Joao Vitor Oliveira Scheidegger', '234.543.123-00', '01/02/1976', 'joao.oliveira@gmail.com', '1234', 1),
...
('Kr Construtora', 'Karine Trein', '1 quartos, 3 banheiros, cozinha, sala de estar junto com a de jantar, lavanderia, sapataria, área de serviço, despensa e sala de cinema', 2, 2),
('Jh Construtora', 'Jhon Heins Gu', '3 quartos, 2 banheiros, cozinha, sala de estar junto com a de jantar, lavanderia, sapataria, área de serviço, despensa, sala de cinema e sala de jogos', 3, 3);

insert into VENDA_COMPRA (data_hora, valor,fk_CORRETOR_codigo, vendedor, comprador, fk_IMOVEL_codigo) values
('01/01/2022 12:54:00', 100000.0, 1, 1, 3, 1),
('02/02/2022 04:59:28', 350000.0, 1, 2, 1, 2),
('03/03/2022 13:32:07', 200000.0, 2, 3, 1, 3),
('04/04/2022 18:23:12', 155000.0, 2, 3, 2, 3);