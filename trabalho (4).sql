...
create table VENDA_COMPRA (
	...
	vendedor serial not null references IMOVEL(codigo)
);
...
insert into VENDA_COMPRA (data_hora, valor,fk_CORRETOR_codigo, vendedor, comprador, fk_IMOVEL_codigo)
('01/01/2022 12:54:00', 100000.0, 1, 1, 3, 1),
('02/02/2022 34:59:28', 350000.0, 1, 2, 1, 2),
('03/03/2022 45:32:07', 200000.0, 2, 3, 1, 3),
('04/04/2022 44:23:12', 155000.0, 2, 3, 2, 3);